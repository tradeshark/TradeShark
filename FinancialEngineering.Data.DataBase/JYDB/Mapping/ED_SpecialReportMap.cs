...
{
	public class ED_SpecialReportMap : EntityTypeConfiguration<ED_SpecialReport>
	{
		public ED_SpecialReportMap()
		{
			// Primary Key
			...
			this.Property(t => t.SpecialCategory).HasColumnName("SpecialCategory");
