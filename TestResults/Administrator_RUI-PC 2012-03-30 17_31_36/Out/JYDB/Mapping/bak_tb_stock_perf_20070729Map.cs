...
{
	public class bak_tb_stock_perf_20070729Map : EntityTypeConfiguration<bak_tb_stock_perf_20070729>
	{
		public bak_tb_stock_perf_20070729Map()
		{
			// Primary Key
			...
			this.ToTable("bak_tb_stock_perf_20070729");
