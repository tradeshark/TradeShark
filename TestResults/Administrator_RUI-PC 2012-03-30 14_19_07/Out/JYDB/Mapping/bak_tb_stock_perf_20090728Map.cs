...
{
	public class bak_tb_stock_perf_20090728Map : EntityTypeConfiguration<bak_tb_stock_perf_20090728>
	{
		public bak_tb_stock_perf_20090728Map()
		{
			// Primary Key
			...
			this.ToTable("bak_tb_stock_perf_20090728");
