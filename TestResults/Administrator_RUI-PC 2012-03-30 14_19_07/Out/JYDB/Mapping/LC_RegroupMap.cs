...
{
	public class LC_RegroupMap : EntityTypeConfiguration<LC_Regroup>
	{
		public LC_RegroupMap()
		{
			// Primary Key
			this.HasKey(t => t.ID);
			...
			this.Property(t => t.AssetBookValue).HasColumnName("AssetBookValue");
			this.Property(t => t.AppraisalValue).HasColumnName("AppraisalValue");
			this.Property(t => t.SaleProceeds).HasColumnName("SaleProceeds");
			this.Property(t => t.TransferIncome).HasColumnName("TransferIncome");
			this.Property(t => t.BookValueOutAsset).HasColumnName("BookValueOutAsset");
			this.Property(t => t.AppraisalValueOutAsset).HasColumnName("AppraisalValueOutAsset");
			this.Property(t => t.RepalcementPriceAssetOut).HasColumnName("RepalcementPriceAssetOut");
			this.Property(t => t.BookValueAssetIn).HasColumnName("BookValueAssetIn");
			this.Property(t => t.AppraisalValueAssetIn).HasColumnName("AppraisalValueAssetIn");
			this.Property(t => t.RepalcementPriceAssetIn).HasColumnName("RepalcementPriceAssetIn");
			this.Property(t => t.DebtRearrangementSum).HasColumnName("DebtRearrangementSum");
