...
{
	public class View_GP_FBalanceSheet_HBMap : EntityTypeConfiguration<View_GP_FBalanceSheet_HB>
	{
		public View_GP_FBalanceSheet_HBMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_FBalanceSheet_HB");
