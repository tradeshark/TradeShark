...
{
	public class bak_stock_perf_20090712Map : EntityTypeConfiguration<bak_stock_perf_20090712>
	{
		public bak_stock_perf_20090712Map()
		{
			// Primary Key
			...
			this.ToTable("bak_stock_perf_20090712");
