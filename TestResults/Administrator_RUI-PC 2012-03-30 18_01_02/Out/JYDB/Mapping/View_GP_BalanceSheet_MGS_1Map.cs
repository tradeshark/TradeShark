...
{
	public class View_GP_BalanceSheet_MGS_1Map : EntityTypeConfiguration<View_GP_BalanceSheet_MGS_1>
	{
		public View_GP_BalanceSheet_MGS_1Map()
		{
			// Primary Key
			...
			this.ToTable("View_GP_BalanceSheet_MGS_1");
