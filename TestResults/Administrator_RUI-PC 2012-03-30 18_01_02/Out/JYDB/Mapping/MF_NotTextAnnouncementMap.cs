...
{
	public class MF_NotTextAnnouncementMap : EntityTypeConfiguration<MF_NotTextAnnouncement>
	{
		public MF_NotTextAnnouncementMap()
		{
			// Primary Key
			this.HasKey(t => t.ID);
			...
			this.ToTable("MF_NotTextAnnouncement");
