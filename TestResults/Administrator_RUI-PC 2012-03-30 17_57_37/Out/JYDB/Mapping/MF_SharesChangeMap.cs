...
{
	public class MF_SharesChangeMap : EntityTypeConfiguration<MF_SharesChange>
	{
		public MF_SharesChangeMap()
		{
			// Primary Key
			...
			this.Property(t => t.SharesChange).HasColumnName("SharesChange");
			this.Property(t => t.RateOfSharesChange).HasColumnName("RateOfSharesChange");
		}
	}
}
