...
{
	public class LC_AccruedLiabilityMap : EntityTypeConfiguration<LC_AccruedLiability>
	{
		public LC_AccruedLiabilityMap()
		{
			// Primary Key
			...
			this.ToTable("LC_AccruedLiability");
			this.Property(t => t.ID).HasColumnName("ID");
			this.Property(t => t.CompanyCode).HasColumnName("CompanyCode");
			this.Property(t => t.EndDate).HasColumnName("EndDate");
			this.Property(t => t.InfoSource).HasColumnName("InfoSource");
			this.Property(t => t.SecurityLoss).HasColumnName("SecurityLoss");
			this.Property(t => t.PenaltyCost).HasColumnName("PenaltyCost");
			this.Property(t => t.QualityAssuranceCost).HasColumnName("QualityAssuranceCost");
			this.Property(t => t.OtherAccruedLiability).HasColumnName("OtherAccruedLiability");
