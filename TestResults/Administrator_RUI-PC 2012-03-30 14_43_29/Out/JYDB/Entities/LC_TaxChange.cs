...
namespace FinancialEngineering.Data.Database.Entities
{
	public class LC_TaxChange
	{
		...
		public string TaxChangeObject { get; set; }
		public Nullable<int> ObjectType { get; set; }
		public Nullable<decimal> TaxRatePreChange { get; set; }
		public Nullable<decimal> TaxRateAfterChange { get; set; }
		public Nullable<int> TaxFavorMethod { get; set; }
		public Nullable<decimal> ImplementTerm { get; set; }
		public Nullable<System.DateTime> ImplementTermBeginDate { get; set; }
		public Nullable<System.DateTime> ImplementTermEndDate { get; set; }
