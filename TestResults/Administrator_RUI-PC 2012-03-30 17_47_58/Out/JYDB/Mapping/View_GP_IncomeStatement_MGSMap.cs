...
{
	public class View_GP_IncomeStatement_MGSMap : EntityTypeConfiguration<View_GP_IncomeStatement_MGS>
	{
		public View_GP_IncomeStatement_MGSMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_IncomeStatement_MGS");
