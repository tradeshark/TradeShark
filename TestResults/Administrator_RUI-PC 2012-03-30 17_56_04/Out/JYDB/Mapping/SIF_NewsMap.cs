...
{
	public class SIF_NewsMap : EntityTypeConfiguration<SIF_News>
	{
		public SIF_NewsMap()
		{
			// Primary Key
			this.HasKey(t => new { t.ID, t.InfoPublDate, t.ContentType, t.InfoTitle, t.UpdateTime, t.JSID });
			...
			this.Property(t => t.InvolvedIndex)
				.HasMaxLength(1000);
				
			// Table & Column Mappings
			this.ToTable("SIF_News");
			...
			this.Property(t => t.InvolvedIndex).HasColumnName("InvolvedIndex");
