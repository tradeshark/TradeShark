...
{
	public class LC_AShareIPOMap : EntityTypeConfiguration<LC_AShareIPO>
	{
		public LC_AShareIPOMap()
		{
			// Primary Key
			...
			this.Property(t => t.ColeadUnderwriter)
				.HasMaxLength(500);
				
			this.Property(t => t.ListingSponsor)
				.HasMaxLength(500);
				
			this.Property(t => t.Distributor)
				.HasMaxLength(500);
				
			this.Property(t => t.InternationalCoordinator)
				.HasMaxLength(500);
			...
			this.Property(t => t.NAPSBeforeIssue).HasColumnName("NAPSBeforeIssue");
			this.Property(t => t.NAPSAfterIssue).HasColumnName("NAPSAfterIssue");
			this.Property(t => t.IssueResultPublDate).HasColumnName("IssueResultPublDate");
			this.Property(t => t.NormalLegalPersonShareLD).HasColumnName("NormalLegalPersonShareLD");
			this.Property(t => t.StrategicInvestorShareLD).HasColumnName("StrategicInvestorShareLD");
			this.Property(t => t.LeadUnderwriter).HasColumnName("LeadUnderwriter");
			this.Property(t => t.ColeadUnderwriter).HasColumnName("ColeadUnderwriter");
			this.Property(t => t.ListingSponsor).HasColumnName("ListingSponsor");
			this.Property(t => t.Distributor).HasColumnName("Distributor");
			this.Property(t => t.InternationalCoordinator).HasColumnName("InternationalCoordinator");
			this.Property(t => t.NormalLegalPersonShare).HasColumnName("NormalLegalPersonShare");
			this.Property(t => t.StrategicInvestorShare).HasColumnName("StrategicInvestorShare");
			this.Property(t => t.OtherPlacingShare).HasColumnName("OtherPlacingShare");
			this.Property(t => t.PlacingShareProportion).HasColumnName("PlacingShareProportion");
			this.Property(t => t.TotalSharesListDate).HasColumnName("TotalSharesListDate");
			this.Property(t => t.TotalSharesBeforeIssue).HasColumnName("TotalSharesBeforeIssue");
			this.Property(t => t.FirstAvgPrice).HasColumnName("FirstAvgPrice");
			this.Property(t => t.FirstTurnoverVolume).HasColumnName("FirstTurnoverVolume");
			this.Property(t => t.FirstTurnoverValue).HasColumnName("FirstTurnoverValue");
			this.Property(t => t.FirstChangePCT).HasColumnName("FirstChangePCT");
