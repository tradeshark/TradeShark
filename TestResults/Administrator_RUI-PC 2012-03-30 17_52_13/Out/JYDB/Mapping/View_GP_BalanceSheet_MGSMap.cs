...
{
	public class View_GP_BalanceSheet_MGSMap : EntityTypeConfiguration<View_GP_BalanceSheet_MGS>
	{
		public View_GP_BalanceSheet_MGSMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_BalanceSheet_MGS");
