...
{
	public class View_GP_BalanceSheet_HBMap : EntityTypeConfiguration<View_GP_BalanceSheet_HB>
	{
		public View_GP_BalanceSheet_HBMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_BalanceSheet_HB");
