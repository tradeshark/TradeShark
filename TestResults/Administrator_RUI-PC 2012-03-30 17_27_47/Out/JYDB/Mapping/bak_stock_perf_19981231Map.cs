...
{
	public class bak_stock_perf_19981231Map : EntityTypeConfiguration<bak_stock_perf_19981231>
	{
		public bak_stock_perf_19981231Map()
		{
			// Primary Key
			...
			this.ToTable("bak_stock_perf_19981231");
