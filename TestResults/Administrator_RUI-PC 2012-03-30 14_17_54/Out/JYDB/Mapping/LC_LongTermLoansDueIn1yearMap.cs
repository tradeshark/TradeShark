...
{
	public class LC_LongTermLoansDueIn1yearMap : EntityTypeConfiguration<LC_LongTermLoansDueIn1year>
	{
		public LC_LongTermLoansDueIn1yearMap()
		{
			// Primary Key
			...
			this.ToTable("LC_LongTermLoansDueIn1year");
