...
{
	public class vw_research_companyfinance
	{
		public System.DateTime endDate { get; set; }
		public string secucode { get; set; }
		public Nullable<decimal> OperatingRevenue { get; set; }
		public Nullable<decimal> MainOperatingProfit { get; set; }
		...
		public Nullable<decimal> NonoperatingProfit { get; set; }
		...
		public Nullable<decimal> LongtermInvest { get; set; }
