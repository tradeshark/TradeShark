...
{
	public class VIEW_GP_FHSG
	{
		public string N_DiviObject { get; set; }
		public string N_PriceUnit { get; set; }
		public string N_IfDividend { get; set; }
		public string N_IFSchemeChange { get; set; }
		public string N_IfDiviBeforeChange { get; set; }
		public Nullable<decimal> SGB { get; set; }
