...
{
	public class View_GP_CashFlowStatement_HBMap : EntityTypeConfiguration<View_GP_CashFlowStatement_HB>
	{
		public View_GP_CashFlowStatement_HBMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_CashFlowStatement_HB");
