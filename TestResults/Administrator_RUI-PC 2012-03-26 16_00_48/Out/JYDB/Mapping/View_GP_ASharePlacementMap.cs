...
{
	public class View_GP_ASharePlacementMap : EntityTypeConfiguration<View_GP_ASharePlacement>
	{
		public View_GP_ASharePlacementMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_ASharePlacement");
