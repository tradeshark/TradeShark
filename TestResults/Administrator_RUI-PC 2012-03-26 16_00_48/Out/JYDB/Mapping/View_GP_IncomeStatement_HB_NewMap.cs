...
{
	public class View_GP_IncomeStatement_HB_NewMap : EntityTypeConfiguration<View_GP_IncomeStatement_HB_New>
	{
		public View_GP_IncomeStatement_HB_NewMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_IncomeStatement_HB_New");
