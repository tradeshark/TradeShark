...
{
	public class View_GP_LongTermLoansDueIn1yearMap : EntityTypeConfiguration<View_GP_LongTermLoansDueIn1year>
	{
		public View_GP_LongTermLoansDueIn1yearMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_LongTermLoansDueIn1year");
