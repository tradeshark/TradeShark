...
{
	public class VIEW_ZQ_ZBQKMap : EntityTypeConfiguration<VIEW_ZQ_ZBQK>
	{
		public VIEW_ZQ_ZBQKMap()
		{
			// Primary Key
			this.HasKey(t => new { t.ID, t.InnerCode, t.IssueDate, t.IssueType, t.BidType, t.XGRQ });

			// Properties
			this.Property(t => t.N_IssueType)
				.HasMaxLength(300);
				
			this.Property(t => t.N_BidType)
				.HasMaxLength(300);
				
			this.Property(t => t.InnerCode)
				.HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
				
			this.Property(t => t.IssueType)
				.HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
				
			this.Property(t => t.BidType)
				.HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
			...
			this.ToTable("VIEW_ZQ_ZBQK");
			this.Property(t => t.N_IssueType).HasColumnName("N_IssueType");
			this.Property(t => t.N_BidType).HasColumnName("N_BidType");
