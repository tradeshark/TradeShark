...
{
	public class View_GP_FIncomeStatement_HBMap : EntityTypeConfiguration<View_GP_FIncomeStatement_HB>
	{
		public View_GP_FIncomeStatement_HBMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_FIncomeStatement_HB");
