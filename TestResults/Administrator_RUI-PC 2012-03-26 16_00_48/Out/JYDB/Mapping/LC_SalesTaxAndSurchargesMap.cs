...
{
	public class LC_SalesTaxAndSurchargesMap : EntityTypeConfiguration<LC_SalesTaxAndSurcharges>
	{
		public LC_SalesTaxAndSurchargesMap()
		{
			// Primary Key
			...
			this.ToTable("LC_SalesTaxAndSurcharges");
