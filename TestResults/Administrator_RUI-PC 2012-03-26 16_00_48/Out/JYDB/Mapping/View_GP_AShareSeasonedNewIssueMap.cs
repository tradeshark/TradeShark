...
{
	public class View_GP_AShareSeasonedNewIssueMap : EntityTypeConfiguration<View_GP_AShareSeasonedNewIssue>
	{
		public View_GP_AShareSeasonedNewIssueMap()
		{
			// Primary Key
			this.HasKey(t => new { t.N_IfExRightAShare, t.ID, t.InnerCode, t.XGRQ, t.JSID });

			// Properties
			this.Property(t => t.N_StockType)
				.HasMaxLength(300);
				
			this.Property(t => t.N_ValidApplyTimesLPOffline)
				.HasMaxLength(300);
				
			this.Property(t => t.N_UnderwritingMode)
				.HasMaxLength(300);
				
			this.Property(t => t.N_ChangeType)
				.HasMaxLength(300);
				
			this.Property(t => t.N_IfExRightAShare)
				.IsRequired()
				.HasMaxLength(2);
			...
			this.ToTable("View_GP_AShareSeasonedNewIssue");
			this.Property(t => t.N_StockType).HasColumnName("N_StockType");
			this.Property(t => t.N_ValidApplyTimesLPOffline).HasColumnName("N_ValidApplyTimesLPOffline");
			this.Property(t => t.N_UnderwritingMode).HasColumnName("N_UnderwritingMode");
			this.Property(t => t.N_ChangeType).HasColumnName("N_ChangeType");
			this.Property(t => t.N_IfExRightAShare).HasColumnName("N_IfExRightAShare");
			this.Property(t => t.N_LotRateOnline).HasColumnName("N_LotRateOnline");
			this.Property(t => t.N_LotRateLPOffline).HasColumnName("N_LotRateLPOffline");
