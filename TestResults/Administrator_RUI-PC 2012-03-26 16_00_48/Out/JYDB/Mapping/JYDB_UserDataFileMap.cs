...
{
	public class JYDB_UserDataFileMap : EntityTypeConfiguration<JYDB_UserDataFile>
	{
		public JYDB_UserDataFileMap()
		{
			// Primary Key
			this.HasKey(t => new { t.ID, t.USERID, t.UPDTYPE, t.FILENAME, t.FILETIME, t.FILEVER, t.XGRQ, t.JSID });
			...
			this.ToTable("JYDB_UserDataFile");
