...
{
	public class LC_FCashFlowStatementNewMap : EntityTypeConfiguration<LC_FCashFlowStatementNew>
	{
		public LC_FCashFlowStatementNewMap()
		{
			// Primary Key
			this.HasKey(t => t.ID);
			...
			this.ToTable("LC_FCashFlowStatementNew");
