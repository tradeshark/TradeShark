...
{
	public class VIEW_HG_GYPCCJGZS_GMJ_SNTQMap : EntityTypeConfiguration<VIEW_HG_GYPCCJGZS_GMJ_SNTQ>
	{
		public VIEW_HG_GYPCCJGZS_GMJ_SNTQMap()
		{
			// Primary Key
			...
			this.ToTable("VIEW_HG_GYPCCJGZS_GMJ_SNTQ");
