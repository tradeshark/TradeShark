...
{
	public class View_GP_MainSHListMap : EntityTypeConfiguration<View_GP_MainSHList>
	{
		public View_GP_MainSHListMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_MainSHList");
