...
{
	public class View_GP_ShortTermLoansMap : EntityTypeConfiguration<View_GP_ShortTermLoans>
	{
		public View_GP_ShortTermLoansMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_ShortTermLoans");
