...
{
	public class VIEW_ZQ_FXJLMap : EntityTypeConfiguration<VIEW_ZQ_FXJL>
	{
		public VIEW_ZQ_FXJLMap()
		{
			// Primary Key
			this.HasKey(t => new { t.ID, t.InnerCode, t.FullName, t.ValueDatePer, t.XGRQ });
