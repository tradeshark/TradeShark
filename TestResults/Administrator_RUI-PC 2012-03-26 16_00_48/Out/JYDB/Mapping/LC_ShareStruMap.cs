...
{
	public class LC_ShareStruMap : EntityTypeConfiguration<LC_ShareStru>
	{
		public LC_ShareStruMap()
		{
			// Primary Key
			...
			this.Property(t => t.OtherFNonListedShares).HasColumnName("OtherFNonListedShares");
		}
	}
}
