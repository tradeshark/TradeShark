...
{
	public class LC_EntrustInvMap : EntityTypeConfiguration<LC_EntrustInv>
	{
		public LC_EntrustInvMap()
		{
			// Primary Key
			this.HasKey(t => t.ID);
			...
			this.Property(t => t.PromisedIncome)
				.HasMaxLength(255);
				
			// Table & Column Mappings
			this.ToTable("LC_EntrustInv");
			...
			this.Property(t => t.EntrustFinanceSum).HasColumnName("EntrustFinanceSum");
			this.Property(t => t.EntrustFinanceTerm).HasColumnName("EntrustFinanceTerm");
			this.Property(t => t.EntrustFinanceBeginDate).HasColumnName("EntrustFinanceBeginDate");
			this.Property(t => t.EntrustFinanceEndDate).HasColumnName("EntrustFinanceEndDate");
			this.Property(t => t.PromisedIncome).HasColumnName("PromisedIncome");
			this.Property(t => t.ActualIncome).HasColumnName("ActualIncome");
