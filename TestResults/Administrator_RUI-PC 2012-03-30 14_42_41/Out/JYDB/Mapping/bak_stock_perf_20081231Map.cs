...
{
	public class bak_stock_perf_20081231Map : EntityTypeConfiguration<bak_stock_perf_20081231>
	{
		public bak_stock_perf_20081231Map()
		{
			// Primary Key
			...
			this.ToTable("bak_stock_perf_20081231");
