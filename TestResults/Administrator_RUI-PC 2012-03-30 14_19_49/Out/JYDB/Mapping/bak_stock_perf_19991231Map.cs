...
{
	public class bak_stock_perf_19991231Map : EntityTypeConfiguration<bak_stock_perf_19991231>
	{
		public bak_stock_perf_19991231Map()
		{
			// Primary Key
			...
			this.ToTable("bak_stock_perf_19991231");
