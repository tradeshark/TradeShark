...
{
	public class View_JJ_FundManager
	{
		public string N_EducationLevel { get; set; }
		public string N_PostName { get; set; }
		public string N_Incumbent { get; set; }
		public string N_Gender { get; set; }
		public Nullable<decimal> N_Performance { get; set; }
