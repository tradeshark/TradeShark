...
{
	public class View_GP_CashFlowStatement_MGSMap : EntityTypeConfiguration<View_GP_CashFlowStatement_MGS>
	{
		public View_GP_CashFlowStatement_MGSMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_CashFlowStatement_MGS");
