...
{
	public class View_GP_MainSHList
	{
		public string N_ShareCharacter { get; set; }
		public string N_SecuCoBelongedCode { get; set; }
		public string N_SHType { get; set; }
		public string N_SecuCode { get; set; }
		public string N_SecuAbbr { get; set; }
		public string N_SHKind { get; set; }
		public Nullable<decimal> N_PCTOfTotalShares { get; set; }
