...
{
	public class View_QZ_Archive
	{
		public string SecuCode { get; set; }
		public string SecuAbbr { get; set; }
		public string N_ChiName { get; set; }
		public string N_ListedState { get; set; }
		public string N_SecuMarket { get; set; }
		public string N_WarrantCategory { get; set; }
		public string N_IssueType { get; set; }
		public string N_IssueWay { get; set; }
		public string N_Process { get; set; }
		public string N_IssuerSN { get; set; }
		public string N_TargetType { get; set; }
		public string N_SecuCode { get; set; }
		public string N_SecuAbbr { get; set; }
		public string N_WarrantType { get; set; }
		public string N_SpecialType { get; set; }
		public string N_WarrantCharacter { get; set; }
		public string N_ExerciseStyle { get; set; }
		public string N_SettlementMode { get; set; }
		public string N_IssuePriceUnit { get; set; }
		public string N_Listed { get; set; }
		public Nullable<decimal> N_IssueRate { get; set; }
