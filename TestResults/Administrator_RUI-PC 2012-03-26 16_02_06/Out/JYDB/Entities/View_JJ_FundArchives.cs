...
{
	public class View_JJ_FundArchives
	{
		public string N_InvestAdvisorCode { get; set; }
		public string N_TrusteeCode { get; set; }
		public string N_Type { get; set; }
		public string N_InvestmentType { get; set; }
		public string N_InvestStyle { get; set; }
