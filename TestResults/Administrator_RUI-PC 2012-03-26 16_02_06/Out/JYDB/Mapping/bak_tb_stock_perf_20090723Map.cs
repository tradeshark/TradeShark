...
{
	public class bak_tb_stock_perf_20090723Map : EntityTypeConfiguration<bak_tb_stock_perf_20090723>
	{
		public bak_tb_stock_perf_20090723Map()
		{
			// Primary Key
			...
			this.ToTable("bak_tb_stock_perf_20090723");
