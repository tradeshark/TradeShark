...
{
	public class View_GP_OtherReceivablesMap : EntityTypeConfiguration<View_GP_OtherReceivables>
	{
		public View_GP_OtherReceivablesMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_OtherReceivables");
