...
{
	public class VIEW_HG_GYPCCJGZS_GYJG_SNTQMap : EntityTypeConfiguration<VIEW_HG_GYPCCJGZS_GYJG_SNTQ>
	{
		public VIEW_HG_GYPCCJGZS_GYJG_SNTQMap()
		{
			// Primary Key
			...
			this.ToTable("VIEW_HG_GYPCCJGZS_GYJG_SNTQ");
