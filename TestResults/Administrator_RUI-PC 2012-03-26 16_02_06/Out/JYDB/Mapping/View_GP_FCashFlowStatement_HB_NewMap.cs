...
{
	public class View_GP_FCashFlowStatement_HB_NewMap : EntityTypeConfiguration<View_GP_FCashFlowStatement_HB_New>
	{
		public View_GP_FCashFlowStatement_HB_NewMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_FCashFlowStatement_HB_New");
			...
			this.Property(t => t.DepositsInCBForPaying).HasColumnName("DepositsInCBForPaying");
			this.Property(t => t.DepositsInInterbank).HasColumnName("DepositsInInterbank");
			this.Property(t => t.LendsToInterbank).HasColumnName("LendsToInterbank");
