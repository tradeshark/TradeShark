...
{
	public class IN_IndustryFinaDataStatMap : EntityTypeConfiguration<IN_IndustryFinaDataStat>
	{
		public IN_IndustryFinaDataStatMap()
		{
			// Primary Key
			...
			this.ToTable("IN_IndustryFinaDataStat");
