...
{
	public class View_GP_CashFlowStatement_HB_1Map : EntityTypeConfiguration<View_GP_CashFlowStatement_HB_1>
	{
		public View_GP_CashFlowStatement_HB_1Map()
		{
			// Primary Key
			...
			this.ToTable("View_GP_CashFlowStatement_HB_1");
