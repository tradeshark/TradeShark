...
{
	public class LC_AddressChangeMap : EntityTypeConfiguration<LC_AddressChange>
	{
		public LC_AddressChangeMap()
		{
			// Primary Key
			this.HasKey(t => t.ID);
			...
			this.Property(t => t.AddressPreChange)
				.HasMaxLength(100);
				
			this.Property(t => t.CodePreChange)
				.HasMaxLength(6);
				
			this.Property(t => t.AddressAfterChange)
				.HasMaxLength(100);
				
			this.Property(t => t.CodeAfterChange)
				.HasMaxLength(6);
				
			// Table & Column Mappings
			this.ToTable("LC_AddressChange");
			...
			this.Property(t => t.AddressChangeType).HasColumnName("AddressChangeType");
			this.Property(t => t.AddressPreChange).HasColumnName("AddressPreChange");
			this.Property(t => t.CodePreChange).HasColumnName("CodePreChange");
			this.Property(t => t.RegionPreChange).HasColumnName("RegionPreChange");
			this.Property(t => t.AddressAfterChange).HasColumnName("AddressAfterChange");
			this.Property(t => t.CodeAfterChange).HasColumnName("CodeAfterChange");
			this.Property(t => t.RegionAfterChange).HasColumnName("RegionAfterChange");
