...
{
	public class VIEW_GP_AccountPayableMap : EntityTypeConfiguration<VIEW_GP_AccountPayable>
	{
		public VIEW_GP_AccountPayableMap()
		{
			// Primary Key
			...
			this.ToTable("VIEW_GP_AccountPayable");
