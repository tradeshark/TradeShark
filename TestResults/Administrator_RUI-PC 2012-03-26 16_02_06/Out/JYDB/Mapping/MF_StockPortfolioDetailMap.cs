...
{
	public class MF_StockPortfolioDetailMap : EntityTypeConfiguration<MF_StockPortfolioDetail>
	{
		public MF_StockPortfolioDetailMap()
		{
			// Primary Key
			this.HasKey(t => new { t.ID, t.InnerCode, t.ReportDate, t.InvestType, t.SerialNumber, t.StockInnerCode, t.XGRQ, t.JSID });
			...
			this.ToTable("MF_StockPortfolioDetail");
