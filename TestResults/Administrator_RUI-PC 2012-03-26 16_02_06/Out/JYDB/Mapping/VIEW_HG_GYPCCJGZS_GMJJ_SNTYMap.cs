...
{
	public class VIEW_HG_GYPCCJGZS_GMJJ_SNTYMap : EntityTypeConfiguration<VIEW_HG_GYPCCJGZS_GMJJ_SNTY>
	{
		public VIEW_HG_GYPCCJGZS_GMJJ_SNTYMap()
		{
			// Primary Key
			...
			this.ToTable("VIEW_HG_GYPCCJGZS_GMJJ_SNTY");
