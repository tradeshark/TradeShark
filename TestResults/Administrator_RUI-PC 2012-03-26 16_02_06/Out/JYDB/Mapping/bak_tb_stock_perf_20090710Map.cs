...
{
	public class bak_tb_stock_perf_20090710Map : EntityTypeConfiguration<bak_tb_stock_perf_20090710>
	{
		public bak_tb_stock_perf_20090710Map()
		{
			// Primary Key
			this.HasKey(t => new { t.id, t.innercode, t.standard, t.industry, t.tradingday, t.closeprice, t.adjustprice, t.referday, t.referprice });
			...
			this.ToTable("bak_tb_stock_perf_20090710");
