...
{
	public class View_GP_FinancialExpenseMap : EntityTypeConfiguration<View_GP_FinancialExpense>
	{
		public View_GP_FinancialExpenseMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_FinancialExpense");
