...
{
	public class View_JJ_BondPortifolioStruMap : EntityTypeConfiguration<View_JJ_BondPortifolioStru>
	{
		public View_JJ_BondPortifolioStruMap()
		{
			// Primary Key
			this.HasKey(t => new { t.ID, t.InnerCode, t.ReportDate, t.BondType, t.XGRQ });
			...
			this.ToTable("View_JJ_BondPortifolioStru");
