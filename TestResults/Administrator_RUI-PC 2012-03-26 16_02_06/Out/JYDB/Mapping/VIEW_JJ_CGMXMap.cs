...
{
	public class VIEW_JJ_CGMXMap : EntityTypeConfiguration<VIEW_JJ_CGMX>
	{
		public VIEW_JJ_CGMXMap()
		{
			// Primary Key
			this.HasKey(t => new { t.ID, t.InnerCode, t.ReportDate, t.SerialNumber, t.StockInnerCode, t.InvestType, t.XGRQ });
