...
{
	public class ED_RetailValueOfSCGoodsMap : EntityTypeConfiguration<ED_RetailValueOfSCGoods>
	{
		public ED_RetailValueOfSCGoodsMap()
		{
			// Primary Key
			this.HasKey(t => t.ID);
			...
			this.ToTable("ED_RetailValueOfSCGoods");
