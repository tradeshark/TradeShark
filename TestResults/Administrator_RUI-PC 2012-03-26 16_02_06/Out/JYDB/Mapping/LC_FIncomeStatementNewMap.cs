...
{
	public class LC_FIncomeStatementNewMap : EntityTypeConfiguration<LC_FIncomeStatementNew>
	{
		public LC_FIncomeStatementNewMap()
		{
			// Primary Key
			this.HasKey(t => t.ID);
			...
			this.ToTable("LC_FIncomeStatementNew");
