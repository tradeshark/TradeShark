...
{
	public class VIEW_HG_GYPCCJGZS_GYJG_SNTY_ExtMap : EntityTypeConfiguration<VIEW_HG_GYPCCJGZS_GYJG_SNTY_Ext>
	{
		public VIEW_HG_GYPCCJGZS_GYJG_SNTY_ExtMap()
		{
			// Primary Key
			...
			this.ToTable("VIEW_HG_GYPCCJGZS_GYJG_SNTY_Ext");
