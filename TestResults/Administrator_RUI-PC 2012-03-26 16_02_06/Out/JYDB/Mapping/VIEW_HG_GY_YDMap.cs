...
{
	public class VIEW_HG_GY_YDMap : EntityTypeConfiguration<VIEW_HG_GY_YD>
	{
		public VIEW_HG_GY_YDMap()
		{
			// Primary Key
			this.HasKey(t => new { t.ID, t.EndDate, t.AdjustMark, t.XGRQ });
