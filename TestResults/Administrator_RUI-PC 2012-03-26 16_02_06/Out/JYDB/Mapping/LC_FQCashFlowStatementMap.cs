...
{
	public class LC_FQCashFlowStatementMap : EntityTypeConfiguration<LC_FQCashFlowStatement>
	{
		public LC_FQCashFlowStatementMap()
		{
			// Primary Key
			...
			this.ToTable("LC_FQCashFlowStatement");
