...
{
	public class LC_AccountPayableMap : EntityTypeConfiguration<LC_AccountPayable>
	{
		public LC_AccountPayableMap()
		{
			// Primary Key
			...
			this.ToTable("LC_AccountPayable");
			...
			this.Property(t => t.AmountToMainDebtor).HasColumnName("AmountToMainDebtor");
			this.Property(t => t.RatioToMainDebtor).HasColumnName("RatioToMainDebtor");
