...
{
	public class View_GP_BSharePlacementMap : EntityTypeConfiguration<View_GP_BSharePlacement>
	{
		public View_GP_BSharePlacementMap()
		{
			// Primary Key
			this.HasKey(t => new { t.N_StockType, t.ID, t.InnerCode, t.InitialInfoPublDate, t.XGRQ, t.JSID });
			...
			this.Property(t => t.N_SchemeChange)
				.HasMaxLength(300);
				
			this.Property(t => t.N_OddLotsTreatment)
				.HasMaxLength(300);
				
			this.Property(t => t.N_PricingModel)
				.HasMaxLength(300);
			...
			this.ToTable("View_GP_BSharePlacement");
			...
			this.Property(t => t.N_SchemeChange).HasColumnName("N_SchemeChange");
			this.Property(t => t.N_OddLotsTreatment).HasColumnName("N_OddLotsTreatment");
			this.Property(t => t.N_PricingModel).HasColumnName("N_PricingModel");
