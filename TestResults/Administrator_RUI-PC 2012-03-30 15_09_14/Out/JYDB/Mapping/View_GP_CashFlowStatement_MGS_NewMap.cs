...
{
	public class View_GP_CashFlowStatement_MGS_NewMap : EntityTypeConfiguration<View_GP_CashFlowStatement_MGS_New>
	{
		public View_GP_CashFlowStatement_MGS_NewMap()
		{
			// Primary Key
			...
			this.ToTable("View_GP_CashFlowStatement_MGS_New");
