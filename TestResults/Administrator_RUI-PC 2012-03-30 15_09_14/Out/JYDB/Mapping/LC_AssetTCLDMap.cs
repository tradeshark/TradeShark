...
{
	public class LC_AssetTCLDMap : EntityTypeConfiguration<LC_AssetTCLD>
	{
		public LC_AssetTCLDMap()
		{
			// Primary Key
			this.HasKey(t => t.ID);
			...
			this.Property(t => t.AssetCustodianSum).HasColumnName("AssetCustodianSum");
			this.Property(t => t.BestowalSum).HasColumnName("BestowalSum");
