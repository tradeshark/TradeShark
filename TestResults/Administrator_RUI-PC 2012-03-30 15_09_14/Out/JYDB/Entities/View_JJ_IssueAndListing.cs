...
{
	public class View_JJ_IssueAndListing
	{
		public string N_FundRaisingMethod { get; set; }
		public string N_FundType { get; set; }
		public string N_ApplyingTimes { get; set; }
		public string N_ListedPlace { get; set; }
		public Nullable<decimal> N_HitRatio { get; set; }
		public Nullable<decimal> N_FirstdayTurnoverRatio { get; set; }
		public Nullable<decimal> N_MiniInitiatorHoldingRatio { get; set; }
