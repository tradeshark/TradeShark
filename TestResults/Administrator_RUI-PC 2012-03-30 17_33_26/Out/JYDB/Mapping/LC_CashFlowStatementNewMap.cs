...
{
	public class LC_CashFlowStatementNewMap : EntityTypeConfiguration<LC_CashFlowStatementNew>
	{
		public LC_CashFlowStatementNewMap()
		{
			// Primary Key
			this.HasKey(t => t.ID);
			...
			this.ToTable("LC_CashFlowStatementNew");
